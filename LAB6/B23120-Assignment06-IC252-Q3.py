...
def generate_samples(initial=False):
    ...
    def plot_samples():
        ...
        # also show the actual normal distribution in background
...
try:
    ...
    std_dev_entry.insert(0, "0")
    generate_samples(initial=True)
